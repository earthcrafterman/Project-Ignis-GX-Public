...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupCost(tp,aux.TRUE,2,false,nil,nil,tp) end
	local g=Duel.SelectReleaseGroupCost(tp,aux.TRUE,2,2,false,nil,nil,tp)

...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if dam>0 then Duel.SetOperationInfo(0,CATEGORY_DAMAGE,nil,0,PLAYER_ALL,dam) end
end
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local dam=Duel.GetMatchingGroupCount(s.filter,PLAYER_ALL,LOCATION_MZONE,LOCATION_MZONE,nil)*500
